            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute w-full bottom-5 left-0 text-center">
                ...
                >
                  ...
                  <p className="text-lg text-secondary">Co Founder</p>
                  <div>
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute w-full bottom-5 left-0 text-center">
                ...
                >
                  ...
                  <p className="text-lg text-secondary">Senior Officer</p>
                  <div>
                    <span className="absolute left-0 bottom-0">
                      <svg
                        width="61"
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute w-full bottom-5 left-0 text-center">
                ...
                >
                  ...
                  <p className="text-lg text-secondary">Senior Manager</p>
                  <div>
                    <span className="absolute left-0 bottom-0">
                      <svg
                        width="61"
            ...
            <div className="relative rounded-lg overflow-hidden">
              ...
              <div className="absolute w-full bottom-5 left-0 text-center">
                ...
                >
                  ...
                  <p className="text-lg text-secondary">Sales Manager</p>
                  <div>
                    <span className="absolute left-0 bottom-0">
                      <svg
                        width="61"
