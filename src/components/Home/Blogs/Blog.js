...
const Blog = () => {
    ...
    return (
        <div className='w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-32 gap-10 mb-20'>
            {
                blogs.map(item => (
                    <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md bg-info">
                        <div className="flex space-x-4">
                            <img alt="" src={item.userImg} className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
